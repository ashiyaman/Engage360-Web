        ...
        >
          ...
          <div className="m-header">
            <div className="m-header-text">
              ...
              <div className="m-title">Add New Lead</div>
            </div>
          ...
          <form onSubmit={handleSave}>
            <div className="m-body">
              <div className="m-grid">
                ...
                <div className="m-field full">
                  <label className="m-label">Sales Agent</label>
                  <div className="m-select-wrap">
                    <select
                      required
                      className="m-select"
                      value={formData.salesAgent}
                      onChange={set("salesAgent")}
                    >
                      <option value="" disabled>Select agent</option>
                      {(agents || []).map((a) => (
                ...
                <div className="m-field">
                  <label className="m-label">Source</label>
                  <div className="m-select-wrap">
                    <select className="m-select" value={formData.source} onChange={set("source")}>
                ...
                <div className="m-field">
                  ...
                  <div className="m-select-wrap">
                    <select className="m-select" value={formData.status} onChange={set("status")}>
                ...
                <div className="m-field">
                  ...
                  <div className="m-select-wrap">
                    <select className="m-select" value={formData.priority} onChange={set("priority")}>
                ...
                <div className="m-field">
                  <label className="m-label">Time to Close (days)</label>
                  <input
                    type="number"
                    min="1"
                    required
            ...
            <div className="m-footer">
              ...
              <button type="submit" className="m-btn m-btn-primary">Create Lead</button>
            </div>
          </form>
        </div>
      </div>

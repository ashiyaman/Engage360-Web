...
// const LeadList = () => {
//   const { leads, fetchLeads, agents } = useContext(LeadContext);
...
//   const leadsByStatus = (sortedLeads || []).reduce((acc, curr) => {
...
//     <>
//       <style>{css}</style>
//       {selectedLead !== null && <LeadDetails lead={selectedLead}/>}
//       <section className="e360-toolbar">
//         <div className="e360-control">
//           <span className="e360-control-label">Filter by Agent</span>

//           <button
//             className={`e360-pill ${selectedAgent === "All" ? "active" : ""}`}
...
//               key={agent._id}
//               className={`e360-pill ${
//                 selectedAgent === agent._id ? "active" : ""
//               }`}
...
//         <div className="e360-control">
//           <span className="e360-control-label">Sort by</span>

//           <button
//             className={`e360-pill sort-variant ${
//               sortBy === "" ? "active" : ""
//             }`}
//             onClick={() => setSortBy("")}
//           >
...
//           <button
//             className={`e360-pill sort-variant ${
//               sortBy === "timeToClose" ? "active" : ""
//             }`}
//             onClick={() => setSortBy("timeToClose")}
//           >
//             Time to Close
//           </button>
//         </div>
...
const LeadList = () => {
  ...
  return (
    <>
      ...
      {/* Modal overlay — only mounts when a lead is selected, board stays mounted behind it */}
      {selectedLead !== null && (
